package cn.sleepybear.zkpdfintegration.advice;
 ...
 * @date 2021/8/10 1:59
 */
@RestControllerAdvice(basePackages = {"cn.sleepybear.zkpdfintegration.controller"})
@Slf4j
public class ControllerReturnAdvice implements ResponseBodyAdvice<Object> {
    ...
    public <T> ResultCode<T> handlerGlobeMyException(HttpServletRequest request, FrontException exception) {
        ...
        return new ResultCode<>(exception.getCode(), exception.getMessage(), null);
    }
